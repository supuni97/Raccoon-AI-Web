...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static" sx={{ backgroundColor:"#29abe2",boxShadow:'none'}}>
      <Container maxWidth="xl">
        <Toolbar style={{display:'flex', width:'100%'}}>
          
          <Avatar sx={{height:40,width:40, mr: 2 }}  alt='logo' src='https://raccoon-ai.sltdigitallab.lk/assets/img/logo/raccoon-new-small.png'/> 
