...
return (
    ...
    <div>
     ...
     Set Link
      ...
      autoComplete="off"
    >
      <TextField id="outlined-basic" label="Please enter the link to the file " variant="outlined" />
      </Box>
 ...
 <Button href="http://localhost:3000/category" className={styles.button4}  type="submit"variant="outlined" onClick={handleClickOpen}>
                fetch
            </Button>
